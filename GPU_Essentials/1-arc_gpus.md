...
|:-----|:-----|-------:|:------------|:-----------|
|[T4](https://www.nvidia.com/content/dam/en-zz/Solutions/Data-Center/tesla-t4/t4-tensor-core-datasheet.pdf)|Falcon |18| PCIe, 1 GPU per node | none|
|V100| Falcon| 80| PCIe, 2 GPUs per node| none|
|[A30](https://www.nvidia.com/content/dam/en-zz/Solutions/data-center/products/a30-gpu/pdf/a30-datasheet.pdf?ncid=no-ncid)| Falcon| 128| PCIe, 4 GPUs per node| NVLink Bridge 2-way|
|[L40S](https://www.nvidia.com/en-us/data-center/l40s/)| Falcon | 80| PCIe, 4 GPUs per node | none|
|[A100](https://www.nvidia.com/content/dam/en-zz/Solutions/Data-Center/a100/pdf/nvidia-a100-datasheet-nvidia-us-2188504-web.pdf)| Tinkercliffs, Biomed, CUI | 136| SXM, 8 GPUs per node| NVSwitch, HDR IB |
|[H200](https://resources.nvidia.com/en-us-data-center-overview/hpc-datasheet-sc23-h200)| Tinkercliffs | 48 | SXM, 8 GPUs per node | NVSwitch, NDR IB |
|[_B200_](https://resources.nvidia.com/en-us-blackwell-architecture?ncid=no-ncid)| _Owl (summer 2026)_| _32_ | _SXM, 8 GPUs per node_ | _NVSwitch_ |
