...
8. [Searching (Columnar) Data:  awk utility](./awk.md)
9. [Searching and Replacing Text:  sed utility](./sed.md)
10. [See Portions of File Contents:  cat and head and tail Utilities](./cat-head-tail.md)
